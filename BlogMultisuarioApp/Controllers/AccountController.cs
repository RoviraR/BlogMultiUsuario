...
namespace BlogMultisuarioApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            var redirectUri = "https://localhost:7084/Home/Index";  // URL de redirección después de logout
        ...
        public IActionResult Register()
        {
            ...
            var redirectUri = "https://localhost:7084/Account/Login"; // debe coincidir con lo configurado en Cognito
