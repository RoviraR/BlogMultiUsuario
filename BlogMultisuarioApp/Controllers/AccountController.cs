...
namespace BlogMultisuarioApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            var redirectUri = "http://blogmultiusuarioapp-env.eba-h8cibmhk.us-east-1.elasticbeanstalk.com/";  // URL de redirección después de logout
        ...
        public IActionResult Register()
        {
            ...
            var redirectUri = "http://blogmultiusuarioapp-env.eba-h8cibmhk.us-east-1.elasticbeanstalk.com/Account/Login"; // debe coincidir con lo configurado en Cognito
