...
namespace BlogMultisuarioApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            var redirectUri = "https://tajama03-env.eba-3se5iiix.us-east-1.elasticbeanstalk.com/";  // URL de redirección después de logout
        ...
        {
            var clientId = "6nej8qanjv13q0kobf3glnr9d2"; // tu Client ID
            var redirectUri = "https://tajama03-env.eba-3se5iiix.us-east-1.elasticbeanstalk.com/Account/Login"; // debe coincidir con lo configurado en Cognito
            var domain = "us-east-1vtFErItEI.auth.us-east-1.amazoncognito.com"; // tu dominio de Cognito
